...
$result_transaksi_masuk = mysqli_query($conn, "SELECT * FROM tb_transaksi WHERE username = '$username'");
...
$chart_pie_bg_color = ['#4e73df', '#1cc88a', '#36b9cc'];
$chart_pie_hover = ['#2e59d9', '#17a673', '#2c9faf'];
?>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Transaksi</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">Total : <?= $total_transaksi_masuk; ?></div>
                                            </div>
                                            <div class="col-auto">
