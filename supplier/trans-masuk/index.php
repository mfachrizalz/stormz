...
@$trans_in_status = $_SESSION['trans-in-status'];

$id_trans = [];
$trans_temp_id = mysqli_query($conn, "SELECT id_barang FROM tb_transaksi_detail_temp WHERE status = 'IN' AND username = '$username'");
...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function alert_trans_in(status) {
                let title_state;
                let text_state;
                let icon_state;
                if (status == 1) {
            ...
            function stokFinal() {
                ...
                let jumlahMasuk = parseInt(document.getElementById('jumlah-masuk').value);
                let total = stok + jumlahMasuk;
                let stokAkhir = document.getElementById('stok-akhir');
                let invalidFeedback = document.getElementById('invalid-text');
                if (!isNaN(total)) {
                    if (jumlahMasuk == 0) {
                        stokAkhir.value = NaN;
                        document.getElementById('jumlah-masuk').classList.add('is-invalid');
                        document.getElementById("invalid-text").innerHTML = "Jumlah Input Yang Dimasukkan Salah";
                    } else {
                        stokAkhir.value = total;
                        document.getElementById('jumlah-masuk').classList.remove('is-invalid');
                    }
                } else {
                    stokAkhir.value = NaN;
                    document.getElementById('jumlah-masuk').classList.remove('is-invalid');
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <!-- Sidebar -->
            <?php include("./sidebar-trans-masuk.php"); ?>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- Navbar -->
                    <?php include("./navbar-trans-masuk.php"); ?>

                    <!-- Begin Page Content -->
                    <div class="container-fluid">
                        <form
                            method="post"
                            action="./trans-masuk-process.php"
                                            ...
                                            <div class="table-responsive">
                                                <div class="body">
                                                    <div class="card-header py-3">
                                                        <h5 class="m-0 font-weight-bold text-primary">Input Transaksi Masuk</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="body">
                                                    <div class="form-group">
                                                        <div class="form-line mb-4">
                                                            ...
                                                            <input type="text" name="id-transaksi" value="<?= id_transaction("in"); ?>" class="form-control" readonly="readonly"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                            ...
                                            <div class="table-responsive">
                                                <div class="body">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                            $trans_temp = mysqli_query($conn, "SELECT * FROM tb_transaksi_detail_temp WHERE status = 'IN' AND username = '$username'");
                                                            $no = 1;
                                ...
                                <div class="col">
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <div class="body">
                                                    <input type="submit" name="trans-in" value="Tambah" class="btn btn-primary">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- Footer -->
                <?php include("./footer-trans-masuk.php"); ?>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="jumlah-masuk">Jumlah Masuk</label>
                                                <input type="number" id="jumlah-masuk" onkeyup="stokFinal()" name="jumlah-masuk" class="form-control" min="1" required/>
    ...
    <?php 
        ...
        } else if ($trans_in_status == 2) {
            echo "<script type='text/javascript'>
                alert_trans_in(2);
            </script>";
        }
        unset($_SESSION['trans-in-status']);
        ?>
