...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Selamat Datang di Stormz</div>
        ...
        <section class="page-section" id="software">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Aplikasi yang tersedia</h3>
                </div>
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>2022</h4>
                                <h4 class="subheading">Store Management</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">
                                    Sebuah aplikasi untuk pengelolaan barang di gudang. User yang tersedia adalah
                                    <strong>Manager, Staff, Supplier.</strong>
                                    Ketiganya memiliki peran yang berbeda.
                                </p>
                                <a href="./signin/">
                                    <button type="button" class="btn btn-outline-primary btn-signin-store">Sign-In</button>
                                </a>
                            </div>
                        </div>
                    </li>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12 text-lg-center">&copy; STORMZ 2022</div>
                    <!-- <div class="col-lg-6 my-3 my-lg-0"> <a class="btn btn-dark btn-social mx-2"
                    href="#!" aria-label="Twitter"><i class="fab fa-twitter"></i></a> <a class="btn
                    btn-dark btn-social mx-2" href="#!" aria-label="Facebook"><i class="fab
                    fa-facebook-f"></i></a> <a class="btn btn-dark btn-social mx-2" href="#!"
