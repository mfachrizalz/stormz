                                                        ...
                                                        <div class="body">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <br>
                                                                    <select class="js-select2-select-produk form-select" onchange="requestSelect(1)" name="select-produk" id="select-produk" style="width: 100%">
    ...
    <?php 
        ...
        <script type="text/javascript">
            ...
            btnTransaction.addEventListener("click", function() {
                console.log(count);
                $(`.js-select2-merk`).select2('destroy');
                $(`.js-select2-kategori`).select2('destroy');
                $(`.js-select2-select-produk`).select2('destroy');

                items.innerHTML += `
                    <li class="list-group-item mb-3" id="list-trans-${count}">
                        <div class="row">
                            <div class="col col-md-6">
                                <div class="card mb-2">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Produk ${count}:</h6>
                                    </div>
                                    <div class="card-body py-sm-2">
                                        <div class="table-responsive">
                                            <div class="body">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="select-produk-${count}">Pilih Produk</label>
                                                        <br>
                                                        <select class="js-select2-select-produk form-select" name="select-produk-${count}" id="select-produk-${count}" style="width: 100%">
                                                            <?php foreach($data_select as $result_select) { ?>
                                                            <option value="<?=$result_select['id_barang'] ?>"><?=$result_select['tipe'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="jumlah-keluar-${count}">Jumlah Keluar</label>
                                                        <input type="number" id="jumlah-keluar-${count}" onkeyup="stokFinal()" name="jumlah-keluar-${count}" class="form-control" required/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="stok-akhir-${count}">Stok Akhir</label>
                                                        <input type="number" id="stok-akhir-${count}" name="stok-akhir-${count}" class="form-control" readonly value=""/>
                                                    </div>
                                                </div>
                                                <button type="button" onclick="remove_produk_trans(this, ${count})" class="btn btn-outline-danger" id="btn-delete-trans">
                            ...
                            <div class="col col-md-6">
                                <div class="card mb-2">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Data Produk ${count}:</h6>
                                    </div>
                                    <div class="card-body py-sm-2">
                                        <div class="table-responsice">
                                            <div class="body">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="id-barang-${count}">ID Barang</label>
                                                        <input type="text" id="id-barang-${count}" name="id-barang-${count}" class="form-control" readonly="readonly"/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="foto-${count}">Foto</label> <br>
                                                        <img id="foto-${count}" src="" class="rounded img-profile img-fluid" style="max-height: 10em; object-fit: contain; width: auto;" alt="">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="tipe-${count}">Tipe</label>
                                                        <input type="text" id="tipe-${count}" name="tipe-${count}" class="form-control" readonly="readonly"/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="harga-${count}">Harga</label>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text" id="basic-addon1">Rp</span>
                                                            <input
                                                                type="number"
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="stok-${count}">Stok</label>
                                                        <input
                                                            type="number"
                                                            name="stok-${count}"
                                                            id="stok-${count}"
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="merk-${count}">Merk</label>
                                                        <input type="text" id="merk-${count}" name="merk-${count}" class="form-control" readonly="readonly"/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="kategori-${count}">Kategori</label>
                                                        <select id="kategori-${count}" class="js-select2-kategori" name="kategori-${count}[]" readonly="readonly" style="width:100%" multiple="multiple" disabled>
                                                        </select>  
                                                    </div>
                                                </div>
                                            </div>
            ...
            function remove_produk_trans(e, count) {
                let root = document.getElementById(`list-trans-${count}`);
                let li = e.parentNode;
                while (li != root) {
                    e = li;
                    li = e.parentNode;
            ...
            $(document).ready(function () {
                $('.js-select2-merk').eq(0).select2({placeholder: "Silahkan pilih merk"});
                $('.js-select2-kategori').eq(0).select2({placeholder: "Silahkan pilih kategori"});
                $('.js-select2-select-produk').eq(0).select2({placeholder: "Silahkan pilih produk"});
            });

            async function requestSelect(count) {
