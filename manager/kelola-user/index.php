...
$query = "SELECT * FROM tb_user WHERE role != 'manager'";
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <td class="text-center"> <img src="<?= "../../assets/img/user-foto/".$location.$result['foto']; ?>" style="height: 50px;" alt=""></td>
                                    ...
                                    <a href="../tambah-staff/" class="btn btn-primary">Tambah Staff</a>
                                    <a href="../tambah-supp/" class="btn btn-primary">Tambah Supplier</a>
                                </div>
                            </div>
                        </div>
                    </div>
