...
$result_staff = mysqli_query($conn, "SELECT * FROM tb_user WHERE role = 'staff'");
$total_staff = mysqli_num_rows($result_staff);
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Navbar -->
                <?php include("./navbar-manager.php"); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">Staff : <?= $total_staff; ?></div>
            ...
            <!-- Footer -->
            <?php include("./footer-manager.php"); ?>
